...
function run_task(::Type{Val{:supercell}}, ::Type{Val{:sample}}, args)
    ...
    supercell_create_subdirectories(args["p"], xdatcar, poscar, N, method=args["method"], Nmin=Nmin, potcar=potcar, kpoints=kpoints, incar=incar, include_files=include_files)
end