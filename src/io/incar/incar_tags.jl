...
const INCAR_COMMENTS = Dict{String, String}(
    ...
    "LWANNIER90_RUN" => "executes wannier_setup and subsequently runs WANNIER90 in library mode",
    ...
    "AMIX_MAG" => "is the linear mixing parameter for the magnetization density",
...
const BLOCK_KEYWORDS = Dict{String, Vector{String}}(
    ...
    "MolecularDynamics" => ["IBRION", "ISIF", "TEBEG", "TEEND", "POTIM", "NSW", "SMASS", "ANDERSEN_PROB"],
    "ElectronicConvergence" => ["ENCUT", "ISMEAR", "SIGMA", "EDIFF", "NELMIN", "NELM", "PREC", "ALGO", "AMIN", "AMIX", "AMIX_MAG", "BMIX", "BMIX_MAG"],
    "Output" => ["NWRITE", "LCHARG", "LWAVE", "LORBIT", "BANDGAP"],
    "Setup" => ["ISTART", "ICHARG"],
    "Hybrid" => ["AEXX", "AGGAC", "AGGAX", "ALDAC", "ALDAX"],
