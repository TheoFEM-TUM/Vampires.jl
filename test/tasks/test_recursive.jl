...
args = Dict{String, String}("p" => path_recursive, "eigenval" => "EIGENVAL", "recp" => "")
...
args = Dict{String, Any}("p" => path_recursive, "outcar" => "OUTCAR", "par" => "TOTEN", "N" => "0", "recp" => "")
...
args = Dict{String, Any}("p" => path_recursive, "recp" => "_3", "outcar" => "OUTCAR", "par" => "TOTEN", "N" => "0")

output = @capture_out run_task_recursive(task, subtask, args)

@test output == "The value in ENCUT_300 is: -8.25251696\nThe value in ENCUT_350 is: -8.25259894\n"
