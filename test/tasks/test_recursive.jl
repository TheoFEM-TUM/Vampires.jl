...
args = Dict{String, String}("r"=>true, "p" => path_recursive, "eigenval" => "EIGENVAL", "o"=>"none")
...
args = Dict{String, Any}("p" => path_recursive, "outcar" => "OUTCAR", "par" => "TOTEN", "N" => "0", "o"=>"none", "r"=>true) 
