...
@testset "Extended parameter file read" begin
    ...
    @test config["batch_file_gpu"]["module_paths"] == "/path/to/cpu_modules/"
    @test config["batch_file_gpu"]["module_list"] == "module1,module2"
    @test config["batch_file_gpu"]["exe"] == "vasp_std"
    ...
    @test config["batch_file_cpu"]["module_paths"] == "/path/to/gpu_modules/"
    @test config["batch_file_cpu"]["module_list"] == "module1,module2"
    @test config["batch_file_cpu"]["exe"] == "vasp_std"
